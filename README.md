...
- This project is for educational and analytical purposes only. It is not
intended to provide financial advice, investment recommendations, or trading signals.

- The dashboard analyzes historical market data and portfolio metrics, but past performance does not guarantee
future results. Any investment decisions should be made independently and, when necessary, with the support of a
